...
int main(void)
{
    ...
    cout << "Vector already has 2 values: 1, 2" << endl;
    cout << "Lets push values 4, 6, 8, 10" << endl;
    v.push_back(4);
    v.push_back(6);
    v.push_back(8);
    v.push_back(10);
    ...
    cout << "Value at 3rd index accessed as v[3] is " << v[3] << endl;
    
    // front() and back()
    cout << "We can use front() and back() methods to access a data member at first and last position..";
    cout << "Front is " << v.front() << " and back is " << v.back() << endl;
    ...
    v.resize(v.size() + 4);
    cout << "New size is " << v.size() << " , Capacity is " << v.capacity() << endl;    
